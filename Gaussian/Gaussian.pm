...
$VERSION = 0.06;
package Image::Filter::Gaussian;
bootstrap Image::Filter::Gaussian;

1;
__END__
=head1 NAME

Image::Filter::Gaussian - Gaussian Blur an image.
...
=head1 SYNOPSIS
    ...
    $image = $image->filter("gaussian"); #Load Image::Filter::Blur
    $image->Jpeg("test.jpg"); 

=head1 DESCRIPTION

Image::Filter is a perl module that can apply image filters. This module
implements a gaussian blur. It uses the gd lib from Thomas 
